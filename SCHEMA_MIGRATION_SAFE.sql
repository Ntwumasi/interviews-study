-- Safe Schema Migration: Handles already-existing columns
...
-- 4. Add code_submission column (if not exists)
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.columns
...
-- 5. Add star_responses column (if not exists)
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.columns
...
-- 6. Add video_recording_url column (if not exists)
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.columns
...
-- 8. Insert sample coding scenarios (only if they don't exist)
...
SELECT 'coding', 'Two Sum', 'Find two numbers in an array that add up to a target value.', 'easy',
  ...
  60
WHERE NOT EXISTS (SELECT 1 FROM public.scenarios WHERE title = 'Two Sum' AND interview_type = 'coding');
...
SELECT 'coding', 'Valid Parentheses', 'Determine if a string of brackets is valid.', 'easy',
  ...
  60
WHERE NOT EXISTS (SELECT 1 FROM public.scenarios WHERE title = 'Valid Parentheses' AND interview_type = 'coding');
...
SELECT 'coding', 'Longest Substring Without Repeating Characters', 'Find the length of the longest substring without repeating characters.', 'medium',
  ...
  60
WHERE NOT EXISTS (SELECT 1 FROM public.scenarios WHERE title = 'Longest Substring Without Repeating Characters' AND interview_type = 'coding');
...
SELECT 'coding', 'Add Two Numbers (Linked Lists)', 'Add two numbers represented as linked lists.', 'medium',
  ...
  60
WHERE NOT EXISTS (SELECT 1 FROM public.scenarios WHERE title = 'Add Two Numbers (Linked Lists)' AND interview_type = 'coding');
...
SELECT 'coding', 'Median of Two Sorted Arrays', 'Find the median of two sorted arrays in log time.', 'hard',
  ...
  60
WHERE NOT EXISTS (SELECT 1 FROM public.scenarios WHERE title = 'Median of Two Sorted Arrays' AND interview_type = 'coding');
...
SELECT 'coding', 'Trapping Rain Water', 'Calculate how much rain water can be trapped between bars.', 'hard',
  ...
  60
WHERE NOT EXISTS (SELECT 1 FROM public.scenarios WHERE title = 'Trapping Rain Water' AND interview_type = 'coding');
...
SELECT 'behavioral', 'Leadership and Conflict Resolution', 'Demonstrate leadership skills in challenging situations.', 'medium',
  ...
  30
WHERE NOT EXISTS (SELECT 1 FROM public.scenarios WHERE title = 'Leadership and Conflict Resolution' AND interview_type = 'behavioral');
...
SELECT 'behavioral', 'Handling Failure and Learning', 'Discuss how you handle setbacks and learn from mistakes.', 'easy',
  ...
  30
WHERE NOT EXISTS (SELECT 1 FROM public.scenarios WHERE title = 'Handling Failure and Learning' AND interview_type = 'behavioral');
...
SELECT 'behavioral', 'Innovation and Problem Solving', 'Share examples of creative problem solving.', 'medium',
  ...
  30
WHERE NOT EXISTS (SELECT 1 FROM public.scenarios WHERE title = 'Innovation and Problem Solving' AND interview_type = 'behavioral');
...
SELECT 'behavioral', 'Cross-functional Collaboration', 'Demonstrate ability to work across teams and disciplines.', 'hard',
  ...
  30
WHERE NOT EXISTS (SELECT 1 FROM public.scenarios WHERE title = 'Cross-functional Collaboration' AND interview_type = 'behavioral');
...
SELECT 'system_design', 'Design Instagram', 'Design a photo-sharing social media platform like Instagram.', 'hard',
  ...
  45
WHERE NOT EXISTS (SELECT 1 FROM public.scenarios WHERE title = 'Design Instagram' AND interview_type = 'system_design');
...
SELECT 'system_design', 'Design Uber', 'Design a ride-sharing platform like Uber.', 'hard',
  ...
  45
WHERE NOT EXISTS (SELECT 1 FROM public.scenarios WHERE title = 'Design Uber' AND interview_type = 'system_design');
...
SELECT 'system_design', 'Design Dropbox', 'Design a file storage and synchronization service like Dropbox.', 'medium',
  ...
  45
WHERE NOT EXISTS (SELECT 1 FROM public.scenarios WHERE title = 'Design Dropbox' AND interview_type = 'system_design');
...
SELECT 'system_design', 'Design Rate Limiter', 'Design an API rate limiting system.', 'medium',
  ...
  45
WHERE NOT EXISTS (SELECT 1 FROM public.scenarios WHERE title = 'Design Rate Limiter' AND interview_type = 'system_design');
